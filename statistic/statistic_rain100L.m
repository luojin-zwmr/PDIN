...
struct_model = {
          ...
          struct('model_name','mynet','path',Mynet),...
    };
...
for nnn = 1:nmodel
    ...
    for iii=nstart+1:nstart+nimgs
        ...
        %fprintf('%d: psnr=%6.4f, ssim=%6.4f\n',iii,mean(psnrs(iii,nnn)),mean(ssims(iii,nnn)));
    end
